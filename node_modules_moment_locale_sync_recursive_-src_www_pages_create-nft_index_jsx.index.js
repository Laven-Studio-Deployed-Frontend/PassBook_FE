...
function CreateNft(props) {
    const { isConnected, disconnect, activeProvider, isIdle, connect, isConnecting, principal } = react_3.useConnect();
    const [fileImg, setFileImg] = react_2.useState(true);
    const [listNFt, setListNFt] = react_2.useState([]);
    const [listAllNFt, setListAllNFt] = react_2.useState([]);
    const [superheroes, { loading, error }] = react_3.useCanister('superheroes');
    ...
    const onFinish = async (values) => {
        var _a, _b;
        console.log(values);
        react_toastify_1.toast('Minting NFT!!!');
        ...
        react_toastify_1.toast('Minted NFT success!!!');
        getLIst();
        getListAll();
    };
    ...
    return (react_1.default.createElement(create_nft_elements_1.Container, null,
        react_1.default.createElement(create_nft_elements_1.Wrapper, null,
            react_1.default.createElement(create_nft_elements_1.Title, null, "Create New Item"),
            react_1.default.createElement(create_nft_elements_1.Required, null,
                react_1.default.createElement(create_nft_elements_1.RedIcon, null, "*"),
                " Required fields"),
            react_1.default.createElement(create_nft_elements_1.BodyWrapper, null,
                react_1.default.createElement(antd_1.Form, { name: 'basic', labelCol: { span: 8 }, wrapperCol: { span: 16 }, onFinish: onFinish, onFinishFailed: onFinishFailed, autoComplete: 'off' },
                    react_1.default.createElement(create_nft_elements_1.FormWrapper, null,
                        react_1.default.createElement(create_nft_elements_1.FormItem, null,
                            react_1.default.createElement(antd_1.Form.Item, { name: 'image', rules: [{ required: true, message: 'Please upload image!' }] },
                                react_1.default.createElement(Dragger, { customRequest: requestUpdate },
                                    react_1.default.createElement("p", { className: 'ant-upload-drag-icon' },
                                        react_1.default.createElement(icons_1.InboxOutlined, null)),
                                    react_1.default.createElement("p", { className: 'ant-upload-text' }, "Click or drag file to this area to upload"),
                                    react_1.default.createElement("p", { className: 'ant-upload-hint' }, "Support for a single or bulk upload. Strictly prohibit from uploading company data or other band files")))),
                        react_1.default.createElement(antd_1.Form.Item, { name: 'name', rules: [{ required: true, message: 'Please input NFT name!' }] },
                            react_1.default.createElement(antd_1.Input, { size: 'large', placeholder: 'NFT name' })),
                        react_1.default.createElement(antd_1.Form.Item, { name: 'description' },
                            react_1.default.createElement(antd_1.Input, { size: 'large', placeholder: 'Provide a detailed description of your item' })),
                        react_1.default.createElement(create_nft_elements_1.FormItem, null,
...
exports["default"] = hooks_1.withContext(CreateNft);
